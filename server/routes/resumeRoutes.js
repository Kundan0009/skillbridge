...
router.post('/analyze', optional, upload.single('resume'), validateUploadedFile, validateFileUpload, trackActivity('resume_analysis', req => ({ filename: req.file?.sanitizedName })), analyzeResume);
