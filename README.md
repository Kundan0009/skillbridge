...
A comprehensive, AI-powered resume analysis platform designed for college students and career centers. Built with React, Node.js, and OpenAI integration.

## 🚀 Features

### For Students
- **AI-Powered Analysis**: Advanced resume analysis using OpenAI GPT models
